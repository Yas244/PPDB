    ...
    <header id="header" id="home">
      <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
          <div id="logo">
            <a href="<?=site_url('home/ppdb')?>"><img src="<?=base_url()?>assets/frontend/img/logoizzatul.png" height="50px" alt="TK IZZATUL ISLAM KARAWANG" title="TK IZZATUL ISLAM KARAWANG" /></a>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              <a href="<?=site_url('home')?>"><img src="<?=base_url()?>assets/frontend/img/logoizzatul.png" height="80px" alt="TK IZZATUL ISLAM KARAWANG" title="TK IZZATUL ISLAM KARAWANG" /></a><br><p></p>
              <ul>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              ...
              <ul class="text-white">
                    <li><i class="fa fa-map-marker fa-lg"></i>Alaman taro disini </li>
                    <li><i class="fa fa-phone fa-lg"></i> no telepon taro disini</li>
                    <li><i class="fa fa-envelope fa-lg"></i><a class="text-white" href="mailto:Afriza4192@gmail.com"> email taro disini</a></li>
