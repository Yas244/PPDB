			...
			<header class="header">
				<div class="logo-container">
					<a href="<?=site_url('dashboard')?>" class="logo">
						<img src="<?=base_url()?>assets/backend/assets/images/izzatulbanner.jpg" height="35" alt="Porto Admin" />
					</a>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?=base_url()?>assets/backend/assets/images/izzatul.png" alt="" class="img-circle" data-lock-picture="<?=base_url()?>assets/backend/assets/images/izzatul.png"/>
							</figure>
