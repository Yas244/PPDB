...
class Hasil extends CI_Controller {
  ...
  public function cetak()
  {
    ...
    $pdf = new FPDF('P','mm',array(215,330));
         ...
         $pdf->Cell(200,6,'IZZATUL ISLAM KARAWANG',0,1,'C');
         ...
         $data= $this->M_pendaftar->daftar($id);
             ...
             $pdf->SetFont('Times','',12);
						 $pdf->SetY(120);
						 $pdf->Cell(7,7,'');
             $pdf->Cell(65,7,'dengan ini panitia IZZATUL ISLAM KARAWANG menutuskan saudara dinyatakan :');
             ...
             $pdf->SetFont('Times','B',12);
						 $pdf->SetY(145);
						 $pdf->Cell(7,7,'');
             $pdf->Cell(180,7,'Di IZZATUL ISLAM KARAWANG'.date('Y').'/'.(date('Y')+1),0,1,'C');
             ...
             $pdf->SetFont('Times','B',12);
                 ...
                 $pdf->Cell(7,7,':');
                 $pdf->Cell(65,7,'IZZATUL ISLAM KARAWANG');
                 ...
                 $pdf->Cell(7,7,':');
                 $pdf->Cell(65,7,'Seragam IZZATUL ISLAM');
                  ...
                  $pdf->SetFont('Times','B',12);
                     ...
                     $pdf->SetY(195);
                     $pdf->Cell(12,7,'');
                     $pdf->Cell(65,7,'BU Dewi, M.Pd');
                     $pdf->Cell(7,7,':');
                     $pdf->Cell(65,7,'089530017036 (WA/SMS)');
